...
public class Mage extends Player {
   String[]techniques={"Ice Lance","Fireball","Baragoosh","Tundra Blast","Snow Ball (shoots pink pastries coated in coconut)","Gale Wind","Lightning Storm","Earthquake","Tornado","Shield Spell","Heal","Health Potion"};

   public Mage(String string) {
      ...
      armor=new AtomicInteger(2);
      baseArmor=new AtomicInteger(2);
      ...
      weapon=new Gear(0,0,0,0,0,0,-1,"staff");
   }
